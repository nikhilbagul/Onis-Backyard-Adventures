...
public class SkeletonAI : MonoBehaviour {
	...
	void Update ()
    {
        ...
        angleFOV = Vector3.Angle(this.transform.forward, direction);
        
        if (Vector3.Distance(this.transform.position, player.position) < 10 && angleFOV < 30)            //when the player is within enemy's range and FOV
        {
